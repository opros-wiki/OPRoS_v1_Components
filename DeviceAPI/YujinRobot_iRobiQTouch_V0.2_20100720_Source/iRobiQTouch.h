...
private:
	/**
	 *	YujinRobot_iRobiQTouch API의 파라미터를 저장하는 변수이다.
	 *	TouchSensorComponent로부터 설정되어지며,
	 *	유진로봇 iRobiQ에 연결하기 위한 TCP/IP의 IP, Port와 서비스 ID 등의 항목들이 있다
	 */
