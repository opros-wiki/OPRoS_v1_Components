...
public:
	...
	unsigned long tileRunTime;
	double tiltStartAngle;
	double tiltTargetAngle;
	...
	bool iRobiQ_SetLeftArm(double degree, int time);
	bool iRobiQ_GetLeftArm(double *degree);
	bool iRobiQ_SetRightArm(double degree, int time);
	bool iRobiQ_GetRightArm(double *degree);
