...
Advantech_CAN::Advantech_CAN(void)
{
...
int Advantech_CAN::Initialize(Property parameter)
{
...
int Advantech_CAN::Finalize(void)
{
	//	채널 정보 유무 확인
...
int Advantech_CAN::Disable(void)
{
	if(canInfo.find(_channel) == canInfo.end()) {
		return API_ERROR;
	}
...
int Advantech_CAN::SetParameter(Property parameter)
{
	//	채널 정보 설정
...
int Advantech_CAN::GetParameter(Property &parameter)
{
	if(canInfo.find(_channel) == canInfo.end()) {
		return API_ERROR;
	}
...
int Advantech_CAN::Write(long id, unsigned char *data, int size)
{
	if(canInfo.find(_channel) == canInfo.end()) {
		return API_ERROR;
	}
...
int Advantech_CAN::Read(long &id, unsigned char *data, int size)
{
	if(canInfo.find(_channel) == canInfo.end()) {
		return API_ERROR;
	}
