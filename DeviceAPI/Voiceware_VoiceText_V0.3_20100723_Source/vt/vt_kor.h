...
_DllMode(short)	VT_LOADTTS_KOR(HWND hWnd, int nSpeakerID, char *db_path, char *licensefile);
_DllMode(void)	VT_UNLOADTTS_KOR(int nSpeakerID);
...
_DllMode(short) VT_LOAD_UserDict_KOR(int dictidx, char *filename);
_DllMode(short) VT_UNLOAD_UserDict_KOR(int dictidx);
...
#if defined(WIN32)
	_DllMode(short) VT_PLAYTTS_KOR(HWND hcaller, UINT umsg, char *text_buff, int nSpeakerID, int pitch, int speed, int volume, int pause, int dictidx, int texttype);
	_DllMode(void)	VT_STOPTTS_KOR(void);
	_DllMode(void)	VT_RESTARTTTS_KOR(void);
	_DllMode(void)	VT_PAUSETTS_KOR(void);
#endif
...
_DllMode(short) VT_TextToFile_KOR(int fmt, char *tts_text, char *filename, int nSpeakerID, int pitch, int speed, int volume, int pause, int dictidx, int texttype);
...
_DllMode(int) VT_TextToBuffer_KOR(int fmt, char *tts_text, char *output_buff, int *output_len, int flag, int nThreadID, int nSpeakerID, int pitch, int speed, int volume, int pause, int dictidx, int texttype);



/*===========================================================================*/
/* CONFIGURE API */
_DllMode(void) VT_SetPitchSpeedVolumePause_KOR(int pitch, int speed, int volume, int pause, int nSpeakerID);



/*===========================================================================
SYNOPSIS
	int VT_GetTTSInfo_KOR(int request, char *licensefile, void *value, int valuesize);
...
_DllMode(int) VT_GetTTSInfo_KOR(int request, char *licensefile, void *value, int valuesize);
