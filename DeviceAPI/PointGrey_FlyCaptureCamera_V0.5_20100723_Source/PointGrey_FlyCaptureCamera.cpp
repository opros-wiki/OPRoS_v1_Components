#include "PointGrey_FlyCaptureCamera.h"
...
PointGrey_FlyCaptureCamera::PointGrey_FlyCaptureCamera(void)
...
int PointGrey_FlyCaptureCamera::Initialize(Property parameter)
{
...
int PointGrey_FlyCaptureCamera::Enable(void)
{
...
int PointGrey_FlyCaptureCamera::Disable(void)
{
	_initialize = false;
...
int PointGrey_FlyCaptureCamera::Finalize(void)
{
	return API_SUCCESS;
}

int PointGrey_FlyCaptureCamera::SetParameter(Property parameter)
{
	...
	{
		PrintMessage("ERROR : PointGrey_FlyCaptureCamera::SetParameter() -> Can't find parameter name.\n");
		return API_ERROR;
	}
...
int PointGrey_FlyCaptureCamera::GetParameter(Property &parameter)
{
	...
	//	!parameter.FindName("Flip") )
	//{
	//	PrintMessage("ERROR : PointGrey_FlyCaptureCamera::GetParameter() -> Can't find parameter name.\n");
	//	return API_ERROR;
	//}
...
int PointGrey_FlyCaptureCamera::GetImage(unsigned char *image)
{
	if( _initialize ) {
...
OprosApi *GetAPI()
{
	return new PointGrey_FlyCaptureCamera();
}
