...
/**
 *	HyVision_HVR2130Camera
 *	HyVision에서 제작한 HVR2130 카메라 장치를 제어합니다.
 */
class HyVision_HVR2130Camera : public Camera
{
public:
	HyVision_HVR2130Camera(void);
	virtual ~HyVision_HVR2130Camera(void);
