...
/**
 *	MatroxImaging_MILFrameGrabber
 *	Matrox Imaging 에서 제작한 MIL 프레임 그레버 장치를 제어합니다.
 */
class MatroxImaging_MILFrameGrabber : public Camera
{
public:
	MatroxImaging_MILFrameGrabber(void);
	virtual ~MatroxImaging_MILFrameGrabber(void);
