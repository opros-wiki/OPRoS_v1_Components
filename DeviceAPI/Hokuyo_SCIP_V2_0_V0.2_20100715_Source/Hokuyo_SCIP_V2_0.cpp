...
int Hokuyo_SCIP_V2_0::Initialize(Property parameter)
{
...
int Hokuyo_SCIP_V2_0::Finalize(void)
{
	FinalizeUART();
...
int Hokuyo_SCIP_V2_0::Enable(void)
{
...
int Hokuyo_SCIP_V2_0::Disable(void)
{
...
int Hokuyo_SCIP_V2_0::SetParameter(Property parameter)
{
...
int Hokuyo_SCIP_V2_0::GetParameter(Property &parameter)
{
...
int Hokuyo_SCIP_V2_0::GetLaserScannerData(vector<double> &laserScannerData)
{
	uart->Lock();
...
int Hokuyo_SCIP_V2_0::InitializeUART(Property parameter)
{
