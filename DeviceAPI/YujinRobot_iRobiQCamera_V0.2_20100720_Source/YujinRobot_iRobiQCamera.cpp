...
int YujinRobot_iRobiQCamera::Initialize(Property parameter)
{
...
int YujinRobot_iRobiQCamera::Enable(void)
{
	short resolution;
...
int YujinRobot_iRobiQCamera::Disable(void)
{
	return iRobiQ_DisableCamera();
}

int YujinRobot_iRobiQCamera::Finalize(void)
{
	return iRobiQ_Finalize();
}

int YujinRobot_iRobiQCamera::SetParameter(Property parameter)
{
	if(parameter.FindName("Width") == false) {
	...
	if(parameter.FindName("Height") == false) {
	...
	if(parameter.FindName("pixelBytes") == false) {
	...
	if(parameter.FindName("Flip") == false) {
...
int YujinRobot_iRobiQCamera::GetParameter(Property &parameter)
{
	return API_SUCCESS;
}

int YujinRobot_iRobiQCamera::GetImage(unsigned char *image)
{
	return true;
}
