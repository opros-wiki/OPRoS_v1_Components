...
#define INT1_COS1                2    //INT1 COS1 : only available for PCI-7452/PCI-7442/PCI-7443
#define INT1_COS2                4    //INT1 COS2 : only available for PCI-7452/PCI-7443
#define INT1_COS3                8   //INT1 COS3 : only available for PCI-7452/PCI-7443
...
#define P9812_AIEvent_Manual      0x80   //AI event manual reset
...
#define PCILocInfo(bus, dev, fun) RegBySlot|((bus&0xffff)<<8)|((dev&0x1f)<<3)|(fun&0x7)
...
I16 __stdcall HotResetHoldControl (U16 wCardNumber, U8 enable);
I16 __stdcall HotResetHoldStatus (U16 wCardNumber, U8 *sts);
I16 __stdcall GetInitPattern (U16 CardNumber, U8 patID, U32 *pattern);
I16 __stdcall SetInitPattern (U16 wCardNumber, U8 patID, U32 pattern);
...
I16 __stdcall AI_9221_Config (U16 wCardNumber, U16 ConfigCtrl, U16 TrigCtrl, BOOLEAN AutoResetBuf);
...
I16 __stdcall AI_9221_CounterInterval (U16 wCardNumber, U32 ScanIntrv, U32 SampIntrv);
...
I16 __stdcall AI_ScanReadChannels (U16 wCardNumber, U16 wChannel, U16 wAdRange, U16 *pwBuffer);
I16 __stdcall AI_ReadMultiChannels (U16 wCardNumber, U16 wNumChans, U16 *pwChans, U16 *pwAdRanges, U16 *pwBuffer);
...
I16 __stdcall AI_SetTimeOut (U16 CardNumber, U32 dwTimeOut);
I16 __stdcall AI_ContBufferSetup (U16 CardNumber, void *pwBuffer, U32 dwReadCount, U16 *BufferId);
...
I16 __stdcall DI_ContReadPort (U16 CardNumber, U16 Port, void *Buffer, U32 ReadCount, F64 SampleRate, U16 SyncMode);
I16 __stdcall DI_ContReadPortToFile (U16 CardNumber, U16 Port, U8 *FileName, U32 ReadCount, F64 SampleRate, U16 SyncMode);
...
I16 __stdcall DI_AsyncMultiBuffersHandled (U16 wCardNumber, U16 bufcnt, U16* bufs);
/*---------------------------------------------------------------------------*/
...
I16 __stdcall DO_SimuWritePort (U16 wCardNumber, U16 wNumChans, U32 *pdwBuffer);
...
I16 __stdcall DO_ContWritePort (U16 CardNumber, U16 Port, void *Buffer, U32 WriteCount, U16 Iterations, F64 SampleRate, U16 SyncMode);
...
I16 __stdcall DIO_LinesConfig (USHORT CardNumber, USHORT Port, USHORT Linesdirmap);
I16 __stdcall DIO_LineConfig (USHORT CardNumber, USHORT Port, USHORT Line, USHORT Direction);
...
I16 __stdcall DIO_INT_Event_Message (U16 wCardNumber, I16 mode, HANDLE evt, HANDLE windowHandle, U32 message, U32 callbackAddr);
...
I16 __stdcall DIO_SetCOSInterrupt32 (U16 wCardNumber, U8 Port, U32 ctl, HANDLE *hEvent, BOOLEAN bManualReset);
I16 __stdcall DIO_GetCOSLatchDataInt32(U16 wCardNumber, U8 Port, U32 *CosLData);
/*---------------------------------------------------------------------------*/
...
I16 __stdcall GPTC_Clear (U16 wCardNumber, U16 wGCtr);
I16 __stdcall GPTC_Control (U16 wCardNumber, U16 wGCtr, U16 ParamID, U16 Value);
I16 __stdcall GPTC_Read (U16 wCardNumber, U16 wGCtr, U32 *pValue);
I16 __stdcall GPTC_Setup (U16 wCardNumber, U16 wGCtr, U16 wMode, U16 wSrcCtrl, U16 wPolCtrl, U32 LReg1_Val, U32 LReg2_Val);
I16 __stdcall GPTC_Status (U16 wCardNumber, U16 wGCtr, U16 *pValue);
...
I16 __stdcall WDT_Reload (U16 wCardNumber, U16 Ctr, F32 ovflowSec, F32 *actualSec);
/*---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------*/
I16 __stdcall PCI_DB_Auto_Calibration_ALL(U16 wCardNumber);
I16 __stdcall PCI_Load_CAL_Data(U16 wCardNumber, U16 bank);
I16 __stdcall PCI_EEPROM_CAL_Constant_Update(U16 wCardNumber, U16 bank);
/*----------------------------------------------------------------------------*/
