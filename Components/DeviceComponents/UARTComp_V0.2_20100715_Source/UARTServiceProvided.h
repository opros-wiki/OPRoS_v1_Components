#ifndef _UARTService_PROVIDED_PORT_H
#define _UARTService_PROVIDED_PORT_H
...
/*
 * 
 * UARTService : public ProvidedServicePort
 *
 */
class UARTServiceProvided
	:public ProvidedServicePort, public IUARTService
{
protected:
    IUARTService *pcom;
...
public:
    ...
    // Constructor
    //
	UARTServiceProvided(IUARTService *fn)
	{
		pcom = fn;
	...
	virtual void setup()
	{
		...
		ptr_method = makeProvidedMethod(&IUARTService::SetParameter,pcom,"SetParameter");
		assert(ptr_method != NULL);
		addMethod("SetParameter",ptr_method);
		SetParameterFunc = reinterpret_cast<SetParameterFuncType *>(ptr_method);
		ptr_method = NULL;

		ptr_method = makeProvidedMethod(&IUARTService::GetParameter,pcom,"GetParameter");
		assert(ptr_method != NULL);
		addMethod("GetParameter",ptr_method);
		GetParameterFunc = reinterpret_cast<GetParameterFuncType *>(ptr_method);
		ptr_method = NULL;

		ptr_method = makeProvidedMethod(&IUARTService::GetError,pcom,"GetError");
		assert(ptr_method != NULL);
		addMethod("GetError",ptr_method);
		GetErrorFunc = reinterpret_cast<GetErrorFuncType *>(ptr_method);
		ptr_method = NULL;

		ptr_method = makeProvidedMethod(&IUARTService::WriteData,pcom,"WriteData");
		assert(ptr_method != NULL);
		addMethod("WriteData",ptr_method);
		WriteDataFunc = reinterpret_cast<WriteDataFuncType *>(ptr_method);
		ptr_method = NULL;

		ptr_method = makeProvidedMethod(&IUARTService::ReadData,pcom,"ReadData");
		assert(ptr_method != NULL);
		addMethod("ReadData",ptr_method);
		ReadDataFunc = reinterpret_cast<ReadDataFuncType *>(ptr_method);
		ptr_method = NULL;

		ptr_method = makeProvidedMethod(&IUARTService::Lock,pcom,"Lock");
		assert(ptr_method != NULL);
		addMethod("Lock",ptr_method);
		LockFunc = reinterpret_cast<LockFuncType *>(ptr_method);
		ptr_method = NULL;

		ptr_method = makeProvidedMethod(&IUARTService::Unlock,pcom,"Unlock");
		assert(ptr_method != NULL);
