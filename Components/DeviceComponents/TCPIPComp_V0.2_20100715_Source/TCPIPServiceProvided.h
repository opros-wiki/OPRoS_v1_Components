#ifndef _TCPIPService_PROVIDED_PORT_H
#define _TCPIPService_PROVIDED_PORT_H
...
/*
 * 
 * TCPIPService : public ProvidedServicePort
 *
 */
class TCPIPServiceProvided
	:public ProvidedServicePort, public ITCPIPService
{
protected:
	ITCPIPService *pcom;
...
public:
	...
	// Constructor
	//
	TCPIPServiceProvided(ITCPIPService *fn)
	{
		pcom = fn;
	...
	virtual void setup()
	{
		...
		ptr_method = makeProvidedMethod(&ITCPIPService::SetParameter,pcom,"SetParameter");
		assert(ptr_method != NULL);
		addMethod("SetParameter",ptr_method);
		SetParameterFunc = reinterpret_cast<SetParameterFuncType *>(ptr_method);
		ptr_method = NULL;

		ptr_method = makeProvidedMethod(&ITCPIPService::GetParameter,pcom,"GetParameter");
		assert(ptr_method != NULL);
		addMethod("GetParameter",ptr_method);
		GetParameterFunc = reinterpret_cast<GetParameterFuncType *>(ptr_method);
		ptr_method = NULL;

		ptr_method = makeProvidedMethod(&ITCPIPService::GetError,pcom,"GetError");
		assert(ptr_method != NULL);
		addMethod("GetError",ptr_method);
		GetErrorFunc = reinterpret_cast<GetErrorFuncType *>(ptr_method);
		ptr_method = NULL;

		ptr_method = makeProvidedMethod(&ITCPIPService::WriteData,pcom,"WriteData");
		assert(ptr_method != NULL);
		addMethod("WriteData",ptr_method);
		WriteDataFunc = reinterpret_cast<WriteDataFuncType *>(ptr_method);
		ptr_method = NULL;

		ptr_method = makeProvidedMethod(&ITCPIPService::ReadData,pcom,"ReadData");
		assert(ptr_method != NULL);
		addMethod("ReadData",ptr_method);
		ReadDataFunc = reinterpret_cast<ReadDataFuncType *>(ptr_method);
		ptr_method = NULL;

		ptr_method = makeProvidedMethod(&ITCPIPService::Lock,pcom,"Lock");
		assert(ptr_method != NULL);
		addMethod("Lock",ptr_method);
		LockFunc = reinterpret_cast<LockFuncType *>(ptr_method);
		ptr_method = NULL;

		ptr_method = makeProvidedMethod(&ITCPIPService::Unlock,pcom,"Unlock");
		assert(ptr_method != NULL);
