#ifndef _CNR_7DOFAnalyticInverseKinematicsComp_COMPONENT_H
#define _CNR_7DOFAnalyticInverseKinematicsComp_COMPONENT_H
/*
...
class CNR_7DOFAnalyticInverseKinematicsComp: public Component
	,public IInverseKinematicsService
{
public:
	CNR_7DOFAnalyticInverseKinematicsComp();
	CNR_7DOFAnalyticInverseKinematicsComp(const std::string &compId);
	virtual ~CNR_7DOFAnalyticInverseKinematicsComp();
