#ifndef _KITECH_LinearTrajectoryGenerationComp_COMPONENT_H
#define _KITECH_LinearTrajectoryGenerationComp_COMPONENT_H
/*
...
class KITECH_LinearTrajectoryGenerationComp: public Component
...
public:
	KITECH_LinearTrajectoryGenerationComp();
	KITECH_LinearTrajectoryGenerationComp(const std::string &compId);
	virtual ~KITECH_LinearTrajectoryGenerationComp();
