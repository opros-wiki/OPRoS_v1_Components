#ifndef _KITECH_InverseDynamicsControlComp_COMPONENT_H
#define _KITECH_InverseDynamicsControlComp_COMPONENT_H
/*
...
class KITECH_InverseDynamicsControlComp: public Component
...
protected:
	...
	InverseDynamicsControl *_dynamics;

public:
	KITECH_InverseDynamicsControlComp();
	KITECH_InverseDynamicsControlComp(const std::string &compId);
	virtual ~KITECH_InverseDynamicsControlComp();
