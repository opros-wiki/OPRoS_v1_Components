...
JacobianTranspose::JacobianTranspose (int inverseAxis)
...
dMatrix JacobianTranspose::Forward ()
{
	CTransformMatrix T;
...
dMatrix JacobianTranspose::Jacobian()
{
	//Position Jacobian 
...
dVector JacobianTranspose::Error ()
{
	dVector error(6);
	error.zero ();
...
void JacobianTranspose::SetDesired (double x, double y, double z, double phi, double theta, double psi)
{
	_desired[0] = x;		
	_desired[1] = y;		
	_desired[2] = z; 
