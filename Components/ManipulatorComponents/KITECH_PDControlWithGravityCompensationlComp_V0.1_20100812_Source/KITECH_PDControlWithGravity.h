#ifndef _KITECH_PDControlWithGravity_COMPONENT_H
#define _KITECH_PDControlWithGravity_COMPONENT_H
/*
...
class KITECH_PDControlWithGravity: public Component
	,public ITrackingControlService
{
protected:
	Property parameter;
	int error;
	PDControlWithGravity *_dynamics;

public:
	KITECH_PDControlWithGravity();
	KITECH_PDControlWithGravity(const std::string &compId);
	virtual ~KITECH_PDControlWithGravity();
